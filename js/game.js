...
var graphicAssets = {
    ballURL: 'assets/graphics/ball.png',
    ballName: 'ball',
    
    paddleURL: 'assets/graphics/paddle.png',
    paddleName: 'paddle',
};

var soundAssets = {
    ballBounceURL: 'assets/audio/ballBounce',
    ballBounceName: 'ballBounce',
    
    ballHitURL: 'assets/audio/ballHit',
    ballHitName: 'ballHit',
    
    ballMissedURL: 'assets/audio/ballMissed',
...
var labels = {
    clickToStart: 'Left paddle: W to move up, S to move down, A to charge.\n\nRight paddle: UP and DOWN arrow keys, LEFT key to charge.\n\n- click to start -',
    winner: 'Winner!',
};
...
mainState.prototype = {
    ...
    initKeyboard: function () {
        ...
        this.paddleLeft_charge = game.input.keyboard.addKey(Phaser.Keyboard.A);
        ...
        this.paddleRight_charge = game.input.keyboard.addKey(Phaser.Keyboard.LEFT);
    },
